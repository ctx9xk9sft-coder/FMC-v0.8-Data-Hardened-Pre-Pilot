...
function buildReport(records) {
  ...
  const operationalReadiness = new Map();
  ...
  for (const record of records) {
    ...
    increment(operationalReadiness, record.operationalReadiness);
    increment(resolutionStatus, record.resolutionStatus);
    nestedIncrement(statusClusters, record.internalStatus, record.clusterKey);
    nestedIncrement(readinessClusters, record.operationalReadiness, record.clusterKey);
  ...
  return {
    ...
    totals: {
      ...
      operationalReadiness: mapToObject(operationalReadiness),
